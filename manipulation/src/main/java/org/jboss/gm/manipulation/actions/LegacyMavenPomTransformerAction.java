 ...
 */
public class LegacyMavenPomTransformerAction implements Action<XmlProvider> {
    ...
    public LegacyMavenPomTransformerAction(ManipulationModel alignmentConfiguration,

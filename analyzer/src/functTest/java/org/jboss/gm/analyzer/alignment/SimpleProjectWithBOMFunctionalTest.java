...
public class SimpleProjectWithBOMFunctionalTest extends AbstractWiremockTest {
    ...
    public void setup() {
        stubFor(post(urlEqualTo("/da/rest/v-1/reports/lookup/gavs"))
                .willReturn(aResponse()
                        ...
                        .withBody(readSampleDAResponse("simple-project-with-bom-da-response.json"))));
    ...
    public void ensureAlignmentFileCreated() throws IOException, URISyntaxException {
        final File projectRoot = tempDir.newFolder("simple-project-with-bom");
        ...
        assertThat(alignmentModel).isNotNull().satisfies(am -> {
            ...
            assertThat(am.findCorrespondingChild("root")).satisfies(root -> {
                ...
                assertThat(alignedDependencies)
                        ...
                        .containsOnly(
                                tuple("jboss-threads", "2.3.3.Final-redhat-00002"),
                                tuple("h2", "1.4.197-redhat-00001"));
            });
        });
    }
}

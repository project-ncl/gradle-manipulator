...
public class BaseConvention implements Plugin<Project> {
  ...
  public void apply(Project project) {
    ...
    project.getRepositories().maven(repo -> repo.setUrl(URI.create("https://maven.repository.redhat.com/ga")));
    project.getRepositories().maven(repo -> repo.setUrl(URI.create("https://maven.repository.redhat.com/earlyaccess/all")));

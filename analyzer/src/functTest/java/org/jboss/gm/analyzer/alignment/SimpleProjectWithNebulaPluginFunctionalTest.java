...
public class SimpleProjectWithNebulaPluginFunctionalTest extends AbstractWiremockTest {
    ...
    public void setup() {
        stubFor(post(urlEqualTo("/da/rest/v-1/reports/lookup/gavs"))
                .willReturn(aResponse()
                        ...
                        .withBody(readSampleDAResponse("simple-project-with-nebula-plugin-da-response.json"))));
    ...
    public void ensureAlignmentFileCreated() throws IOException, URISyntaxException {
        final File projectRoot = tempDir.newFolder("simple-project-with-nebula-plugin");
        ...
        assertThat(alignmentModel).isNotNull().satisfies(am -> {
            ...
            assertThat(am.findCorrespondingChild("root")).satisfies(root -> {
                ...
                assertThat(alignedDependencies)
                        ...
                        .containsOnly(
                                tuple("spring-core", "4.3.22.RELEASE-redhat-1"));
            });
        });
    }
}

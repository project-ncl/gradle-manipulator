...
public class GMEFunctionalTest extends AbstractWiremockTest {
    ...
    public void ensureAlignmentFileCreatedAndAlignmentTaskRun() throws IOException {
                ...
                new File(
                        new File(
                                TestUtils.class.getClassLoader()
                                        .getResource("simple-project-da-response.json")
                                        .getPath())
                                .getParentFile()
                                .getParentFile()
                                .getParentFile()
        ...
        assertThat(alignmentModel).isNotNull().satisfies(am -> {
            assertThat(am.getGroup()).isEqualTo("org.jboss.pnc.gradle-manipulator");
            assertThat(am.getName()).isEqualTo("gradle-manipulator");
            assertThat(am.getChildren().keySet()).hasSize(4)

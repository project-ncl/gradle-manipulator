package org.jboss.pnc.gradlemanipulator.common.groovy;
...
public abstract class BaseScript extends GradleBaseScript {
    ...
    /**
     * Internal use only - the org.jboss.pnc.gradle-manipulator.analyzer.alignment.AlignmentTask uses this to

 ...
 *
 * @deprecated This class is scheduled for removal in a future version. To upload artifacts, use the `maven-publish` or
 *             `ivy-publish` plugins instead.
 */
...
public abstract class Upload extends ConventionTask {
     ...
     *
     * @deprecated This class is scheduled for removal in a future version, this method <strong>should not be
     *             used</strong>.
     */
    @Deprecated
    @Inject
        ...
        throw new InvalidUserCodeException(
                "The legacy `Upload` task was removed in Gradle 8. Please use the `maven-publish` or `ivy-publish` plugin instead. "
                        ...
                        docRegistry.getDocumentationRecommendationFor(
                                "on publishing on maven repositories",
                                "publishing_maven",
                                "publishing_maven")
                        + "\n" +
                        docRegistry.getDocumentationRecommendationFor(
                                "on publishing on ivy repositories",
                                "publishing_ivy",
                                "publishing_ivy"));
    }
